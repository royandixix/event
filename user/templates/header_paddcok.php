  ...
  <section class="relative z-10 min-h-screen flex flex-col lg:flex-row items-center justify-between 
    ...
    <div class="max-w-2xl space-y-6">
      <h1 class="text-[clamp(1.6rem,4vw,3rem)] leading-tight drop-shadow-xl">
        Ini adalah halaman paddock<br />
        <span class="text-gray-200">
          Informasi Paddock Lengkap
        </span>
      </h1>

      <p class="text-[clamp(1rem,2.2vw,1.2rem)] text-gray-200 leading-relaxed drop-shadow">
        Selamat datang di halaman paddock, tempat di mana semua persiapan dan logistik berlangsung. 
        Anda bisa menemukan informasi lengkap mengenai tata letak dan fasilitas di sini.
      </p>
    ...
    <div class="mt-12 lg:mt-0 lg:ml-10 w-full max-w-sm rounded-2xl overflow-hidden shadow-lg 
      ...
      <img src="./img/gambar.jpeg" alt="Paddock View" class="w-full h-auto object-cover rounded-t-2xl" />
      <div class="p-6 text-white">
        <h3 class="text-lg mb-2">Peta Paddock dan Fasilitas</h3>
        <p class="text-sm text-gray-200">
          Temukan lokasi tenda tim, area logistik, dan fasilitas umum lainnya.
        </p>
      </div>
    </div>
